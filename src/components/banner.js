...
import Banner from "../images/background.png"; // your imported banner image
import Logo from "../images/logo-Photoroom.png";
const CustomHeader = () => {
  return (
    <div
      className="relative bg-cover bg-center p-10 text-white"
      style={{ backgroundImage: `url(${Banner})` }} // use imported Banner here
    >
